  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className={`rounded-lg shadow-lg p-6 mb-8 ${darkMode ? 'bg-dark-200 text-gray-200' : 'bg-white text-gray-800'}`}>
        {error && (
          <div className={`border px-4 py-3 rounded mb-4 ${darkMode ? 'bg-red-900 text-red-200 border-red-700' : 'bg-red-100 text-red-700 border-red-400'}`}>
            {error}
          </div>
        )}
        
        {success && (
          <div className={`border px-4 py-3 rounded mb-4 ${darkMode ? 'bg-green-900 text-green-200 border-green-700' : 'bg-green-100 text-green-700 border-green-400'}`}>
            {success}
          </div>
        )}
      ...
      <div className={`rounded-lg shadow-lg p-6 ${darkMode ? 'bg-dark-200 text-gray-200' : 'bg-white text-gray-800'}`}>
        ...
        <div className={`border rounded p-4 ${darkMode ? 'border-red-700' : 'border-red-300'}`}>
